...
<div className="max-w-md mx-auto border rounded-xl shadow-md overflow-hidden md:max-w-3xl mt-20">
  <div className="md:flex">
    <div className="md:shrink-0">
      <Image className="h-48 w-full object-cover md:h-full md:w-48" src={data.imagen} alt='foto proyecto' width={500} height={500}/>
    </div>
    <div className="p-8">
      ...
      <Link href={data.repositorio} className="block mt-1 text-sm leading-tight font-medium text-blue-400 hover:underline">Ver repositorio</Link>
    </div>
  </div>
</div>
  )
