        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="mb-10 ">
            <div className="flex justify-between  w-full overflow-hidden "
             >
                <img  src="/fotoPerfil2.png" alt='foto' className="relative  animate-jump-out animate-once animate-ease-in-out animate-alternate-reverse  animate-duration-[2000ms]">
                </img>
